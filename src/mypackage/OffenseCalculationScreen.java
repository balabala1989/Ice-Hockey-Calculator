...
public class OffenseCalculationScreen extends MainScreen implements FieldChangeListener{
	...
	public OffenseCalculationScreen() {
        ...
        rtfHeading = new RichTextField("Offense Calculation", RichTextField.TEXT_ALIGN_HCENTER){
        ...
        shotsOnGoalEdit = new EditField("","",10, TextField.NO_LEARNING | TextField.NO_NEWLINE | TextField.NON_SPELLCHECKABLE ){
            ...
            shotsOnGoalEdit.setMargin(10,10,10,10);
		...
		goalsScoredEdit = new EditField("","",10, TextField.NO_LEARNING | TextField.NO_NEWLINE | TextField.NON_SPELLCHECKABLE ){
            ...
            goalsScoredEdit.setMargin(10,10,10,10);
		...
		assistsEdit = new EditField("","",10, TextField.NO_LEARNING | TextField.NO_NEWLINE | TextField.NON_SPELLCHECKABLE ){
            protected void paint(Graphics graphics) {
                graphics.clear();
                graphics.setBackgroundColor( Color.WHITE );
            ...
            assistsEdit.setBorder(roundedBorder);
            assistsEdit.setMargin(10,10,10,10);
	    assistsLabel = new LabelField( "Assists" ){
            public void paint(Graphics g ){
                g.setColor(Color.WHITE);
                super.paint(g);
              }
            };
            assistsLabel.setFont( Font.getDefault().derive(Font.EMBOSSED_EFFECT,25,Ui.UNITS_px) );   
		verticalManager.add(assistsLabel);
		...
		gamesWonEdit = new EditField("","",10, TextField.NO_LEARNING | TextField.NO_NEWLINE | TextField.NON_SPELLCHECKABLE ){
            ...
            gamesWonEdit.setMargin(10,10,10,10);
		...
		gamesLostEdit = new EditField("","",10, TextField.NO_LEARNING | TextField.NO_NEWLINE | TextField.NON_SPELLCHECKABLE ){
            ...
            gamesLostEdit.setMargin(10,10,10,10);
		...
		gamesTiedEdit = new EditField("","",10, TextField.NO_LEARNING | TextField.NO_NEWLINE | TextField.NON_SPELLCHECKABLE ){
            protected void paint(Graphics graphics) {
                graphics.clear();
                graphics.setBackgroundColor( Color.WHITE );
            ...
            gamesTiedEdit.setBorder(roundedBorder);
            gamesTiedEdit.setMargin(10,10,5,10);
	    gamesTiedLabel = new LabelField( "Team Games Tied" ){
            public void paint(Graphics g ){
                g.setColor(Color.WHITE);
                super.paint(g);
              }
            };
            gamesTiedLabel.setFont( Font.getDefault().derive(Font.EMBOSSED_EFFECT,25,Ui.UNITS_px) );   
		verticalManager.add(gamesTiedLabel);
		verticalManager.add(gamesTiedEdit);
	        ...
	        calculateButton.setMargin(10, 40, 0, 80);
	        ...
	        backButton.setMargin(10, 40, 0, 80);
		...
		if(field == calculateButton)
		{
			if(calculateButton.getLabel().equals("Calculate"))
			{
				...
				try {
					...
					else if(gamesWon == 0 && gamesLost == 0 && gamesTied == 0 )
					{
						Dialog.inform("Games Won in Goal, Games Lost in Goal and Games Tied in Goal all cannot be zero");
					}
					else if(shotsOnGoal < 0 || goalsScored < 0 || gamesWon < 0 || gamesLost < 0 || gamesTied < 0 || assists < 0)
					{
					...
					{
						gamesTotal = gamesWon + gamesLost + gamesTied;
						...
						scoringPoints = goalsScored + assists;
						teamPoints = (gamesWon * 2) + gamesTied;
						...
						stResult.append("Scoring Percentage : " + format.formatNumber(scoringPercentage, 4) + "\n\n" +
								...
								"Scoring Points : " + String.valueOf(scoringPoints) + "\n\n" +
								"Team Points : " + String.valueOf(teamPoints) + "\n\n" +
			...
			else
			{
				...
				gamesTiedEdit.setEditable(true);
			}
		}
