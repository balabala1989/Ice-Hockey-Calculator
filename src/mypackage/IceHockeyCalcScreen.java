...
public class IceHockeyCalcScreen extends MainScreen implements FieldChangeListener {
    ...
    public IceHockeyCalcScreen() {
        ...
        rtfHeading = new RichTextField("Ice Hockey Calculator", RichTextField.TEXT_ALIGN_HCENTER){
        ...
        defenseButton = new ButtonField( "Defense Calculation", ButtonField.CONSUME_CLICK | FIELD_HCENTER );
        ...
        offenseButton = new ButtonField( "Offense Calculation", ButtonField.CONSUME_CLICK | FIELD_HCENTER );
